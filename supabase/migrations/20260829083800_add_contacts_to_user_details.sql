-- Migration: 20260829083800_add_contacts_to_user_details.sql
-- Description: Add nullable user_id to public.contacts with indexes, and update get_admin_user_full_details RPC to return contact inquiries.
...
-- 3. Replace get_admin_user_full_details RPC function
