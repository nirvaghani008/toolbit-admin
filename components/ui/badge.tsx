...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-md border px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-wider transition-colors focus:outline-none focus:ring-1 focus:ring-zinc-400 dark:focus:ring-zinc-600',
  {
    variants: {
      variant: {
        default:
          'border-zinc-200/80 bg-zinc-100 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/80 dark:text-zinc-300',
        secondary:
        ...
        slate:
          'border-zinc-200/80 bg-zinc-100/80 text-zinc-700 dark:border-zinc-700 dark:bg-zinc-800/80 dark:text-zinc-300',
      },
    },
    defaultVariants: {
      variant: 'default',
